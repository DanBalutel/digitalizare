            ...
            <ul class="sidebar-links" id="simple-bar">
               ...
               <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                  ...
                  <ul class="sidebar-submenu" style="display: none;">
                     ...
                     <li><a href="granturi">Granturi</a></li>
                  </ul>
               </li>
               ...
               <li class="sidebar-list mb-3" style="text-transform: none !important">
                  <a class="sidebar-link" id="showOffer" type="button" data-bs-toggle="modal" data-bs-target="#oferta" data-bs-original-title="Oferta de pret" title="Oferta de pret">
