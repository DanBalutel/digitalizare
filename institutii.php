    ...
    <div class="page-body-wrapper">
        ...
        <div class="page-body">
            ...
            <div class="container-fluid">
                <h3><a href="#" onclick="generatePdfFieldsObj();">Click DEMO</a> - Completare automata documente - Transmitere automata solicitari Institutii</h3>
                <div class="card">
                    <div class="card-body">
...
<script>
    ...
    function generatePdfFieldsObj() {
    let dataObj = JSON.parse(localStorage.dataJson);
    let newdataObj = JSON.parse(localStorage.newdataJson);
    ...
    // or do something else with the fields object
}
