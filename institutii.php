    ...
    <div class="page-body-wrapper">
        ...
        <div class="page-body">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                            <h2 class="mb-1 mt-1">Ministerul Afacerilor Interne</h2>
                            <a href="https://b.politiaromana.ro/files/pages_files/Cerere_eliberare_certificat_cazier_persoane_fizice_anexa_7-modif.22-21.06.2022.pdf" class="h5 text-uppercase">
                                <img src="https://b.politiaromana.ro/favicon.ico" width="40" height="40" alt=""> Cazier judiciar
                            </a>
                            <br>
                            <a href="https://b.politiaromana.ro/files/pages_files/Cerere_eliberare_certificat_integritate_anexa_1.pdf" class="h5 text-uppercase">
                                <img src="https://b.politiaromana.ro/favicon.ico" width="40" height="40" alt=""> CERTIFICAT DE INTEGRITATE COMPORTAMENTALĂ
                            </a>
                            <h2 class="mb-1 mt-1">ANAF</h2>
                            <a href="https://static.anaf.ro/static/10/Anaf/Declaratii_R/descarcare_declaratii.htm" class="h5 text-uppercase">
                            ...
                            <br>
                            <a href="https://chat.anaf.ro/cod_tva.nsf/solicitare_tva" class="h5 text-uppercase">
                            ...
                            <h2 class="mb-1 mt-1">Ministerul Justitiei</h2>
                            <a href="https://constatator.digitalizarefirme.ro/index.html" class="h5 text-uppercase">
                            ...
                            <br>
                            <a href="https://portal.just.ro/SitePages/acasa.aspx" class="h5 text-uppercase">
                                <img src="https://portal.just.ro/_layouts/images/favicon.ico" width="40" height="40" alt=""> Portalul instantelor de judecata
                            </a>
                            <br>
                            <a href="https://legislatie.just.ro" class="h5 text-uppercase">
                                <img src="https://legislatie.just.ro/Content/Images/Site/temanoua/favicon.ico" width="40" height="40" alt=""> PORTAL LEGISLATIV
                            </a>
                            <h2 class="mb-1 mt-1">Ministerul Dezvoltarii, Lucrarilor publice si Administratiei</h2>
                            <a href="https://epay.ancpi.ro/epay/SelectProd.action?prodId=419" class="h5 text-uppercase">
                            ...
                            <h2 class="mb-1 mt-1">Ministerul Finantelor</h2>
                            <a href="https://taxatimbru.ro/calculator-taxa.html" class="h5 text-uppercase">
                            ...
                            <br>
                            <a href="https://taxatimbru.ro/plateste-taxa-timbru-persoana-fizica.html" class="h5 text-uppercase">
