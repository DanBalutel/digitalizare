    ...
    fetch('http://api.raport.ai:3003/generate-pdf', {
        ...
        body: JSON.stringify({
            ...
            'fieldValues': {
                ...
                'sediu_numar': newdataObj.adresa.anaf.numar.toString() || '',
                'sediu_bloc': newdataObj.adresa.anaf.bloc.toString() || '',
                'sediu_scara': newdataObj.adresa.anaf.scara.toString() || '',
                'sediu_etaj': newdataObj.adresa.anaf.etaj.toString() || '',
                ...
                'sediu_telefon': newdataObj.date_contact.telefon || '',
                'sediu_fax': newdataObj.date_contact.fax || '',
