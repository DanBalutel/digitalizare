    ...
    fetch('http://api.raport.ai:3003/generate-pdf', {
        ...
        body: JSON.stringify({
            ...
            'fieldValues': {
                ...
                'nr_ordine_rc':  replaceDiacritics(newdataObj.firma.j) || '',
                'CUI': replaceDiacritics(newdataObj.firma.cui.toString()) || '',
                'sediu_domiciliat': replaceDiacritics(newdataObj.adresa.anaf.localitate) || '',
                'sediu_strada': replaceDiacritics(newdataObj.adresa.anaf.strada) || '',
                'sediu_numar': replaceDiacritics(newdataObj.adresa.anaf.numar) || '',
