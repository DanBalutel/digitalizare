                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="sticky-note" id="boardNone">
                                    ...
                                    <div class="note" style="background: rgba(84, 186, 74, 0.2)" ondragstart="`function(){$(this).css('z-index', ${++noteZindex});}`">
                                        <a href="javascript:;" class="button remove">X</a>
                                        <div class="note_cnt">
                                            <i class="icofont icofont-checked"></i>
                                            <textarea class="title" placeholder="Enter note title">TODO</textarea>
                                            <textarea class="cnt" placeholder="Enter note description here">lista de facut</textarea>
                                        </div>
                                    </div>
